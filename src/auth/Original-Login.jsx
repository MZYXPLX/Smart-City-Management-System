...
function Login() {
  ...
  const handlepassworddataLoginCategories = async () => {
    ...
    try {
      ...
      urlencoded.append("emaildata", "demo@vtrackingsys.com");
      urlencoded.append("passworddata", "Pak54321");
  ...
  const handlepassworddataLogin = async () => {
    ...
    try {
      ...
      var urlencoded = new URLSearchParams();
      urlencoded.append("emaildata", emaildata);
      urlencoded.append("passworddata", passworddata);
  ...
  const fetchGeoFences = async () => {
    ...
    myHeadersx.append("Authorization", "Basic " + btoa(emaildata + ":" + passworddata));
