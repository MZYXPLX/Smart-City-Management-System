...
export default function Sector({ phase, sector, complaint, setComplaint,checkedItems, setCheckedItems }) {
  const [open, setOpen] = useState(0);

  // const dummy = useSelector((state) => state.dummy.items);
      ...
      >
        ...
        >
          <div class="flex cursor-pointer w-full  max-w-sm mx-auto bg-slate-200  shadow-xl hover:shadow-md ring-1 ring-black/5 rounded-xl items-center gap-2 py-2">
            ...
            <div class="flex-initial absolute right-0 mr-20"></div>
