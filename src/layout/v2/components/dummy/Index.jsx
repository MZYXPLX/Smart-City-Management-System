  ...
  return (
    <>
      <div className="flex w-screen items-start justify-center h-screen  rounded  dark:bg-transparent"
        ...
        >
        <Map zoom={zoom} complaint={complaint} cluster={cluster} mapType={mapType} />
        {cluster ? (
          <>
            <div
        ...
        >
          <option value="https://{s}.tile.openstreetmap.org/{z}/{x}/{y}.png">Default Map</option>
          <option value="https://server.arcgisonline.com/ArcGIS/rest/services/World_Imagery/MapServer/tile/{z}/{y}/{x}">Satelite Map</option>
          <option value="https://tiles.stadiamaps.com/tiles/alidade_smooth_dark/{z}/{x}/{y}{r}.png">Dark Map</option>
        </select>
      </div>
    </>
  );
