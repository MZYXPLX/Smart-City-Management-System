  ...
  return (
    <>
      ...
      >
        ...
        <select
          id="maps"
          className=" absolute bottom-36 left-10 p-2 z-10 focus:outline-none text-black border-2 border-gray-400 bg-slate-100 hover:bg-slate-800 hover:text-slate-50 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-slate-50 dark:hover:bg-slate-700 dark:focus:ring-white"
