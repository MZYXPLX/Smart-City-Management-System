...
export default function Subgroup({ item, devices, selectedGroups, setVehicle, vehicle }) {
  ...
  useEffect(() => {
    var keysTrue = Object.keys(checkedItems).filter(k => checkedItems[k]);
    var keysFalse = Object.keys(checkedItems).filter(k => !checkedItems[k]);
        ...
        <AccordionBody>
          ...
          >
            ...
            {Object.values(items).map((item) => {
              return <Device item={item} checkedItems={checkedItems} setCheckedItems={setCheckedItems} />;
            })}
          </ul>
        </AccordionBody>
      </Accordion>
